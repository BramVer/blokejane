...
class Blockchain(object):
    ...
    def valid_chain(self, chain):
        ...
        Loops through each block and verifies hash and proof.
    ...
    def resolve_conflicts(self):
        ...
        downloads the chains and verifies them using valid_chain()
        ...
        # Grab and verify chains from all nodes on network
        for node in neighbours:
            ...
            if response.status_code == 200:
                ...
                # Check if the length is longer and chain valid
